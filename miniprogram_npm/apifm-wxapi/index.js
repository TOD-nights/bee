  ...
  (function (module, exports, __webpack_require__) {
    ...
    module.exports = {
      ...
      commonIP: function commonIP(ip) {
        return request('/common/ip', false, 'get', {
          ip: ip
        });
      },
      ...
      scoreTaskList: function scoreTaskList(token) {
        return request('/score/taskList', true, 'get', {
          token: token
        });
      },
      ...
      fetchWxaMobile: function fetchWxaMobile(code) {
        return request('/user/wxapp/getMobile', true, 'get', {
          code: code
        });
      },
      ...
      qqQrcode: function qqQrcode(content) {
        return request('/user/q/qrcode', true, 'post', {
          content: content
        });
      },
      ...
      nextRegionV2: function nextRegionV2(pid) {
        return request('https://common.apifm.com/' + subDomain + '/region/child', false, 'get', {
          pid: pid
        });
      },
      regionInfoV2: function regionInfoV2(id) {
        return request('https://common.apifm.com/' + subDomain + '/region/info', false, 'get', {
          id: id
        });
      },
      regionInfoBatchV2: function regionInfoBatchV2(ids) {
        return request('https://common.apifm.com/' + subDomain + '/region/infoBatch', false, 'get', {
          ids: ids
        });
      },
      ...
      cmsArticlePreNextV2: function cmsArticlePreNextV2(id) {
        return request('https://cms.apifm.com/' + merchantId + '/cms/news/preNext', true, 'get', {
          id: id
        });
      },
      ...
      cmsArticleDeleteV2: function cmsArticleDeleteV2(token, id) {
        return request('https://cms.apifm.com/' + merchantId + '/cms/news/del', true, 'post', {
          token: token,
          id: id
        });
      },
      ...
      //门店详细
      shopInfo: function shopInfo(id,lat,lng) {
        return request('/shop/subshop/info?id='+id+"&lat="+lat+"&lng="+lng, true, 'get', {});
      },
      ...
      anonymousUserInfo: function anonymousUserInfo(id) {
        return request('/user/anonymous/info', true, 'get', {
          id: id
        });
      },
      ...
      userLogedList: function userLogedList(token) {
        return request('/user/logedUserList', true, 'get', {
          token: token
        });
      },
      ...
      cyTableInfo: function cyTableInfo(id) {
        return request('/cyTable/info', true, 'get', {
          id: id
        });
      },
      ...
      tempDataSetV2: function tempDataSetV2(key, content) {
        return request('https://common.apifm.com/' + merchantId + '/tempData/set', true, 'post', {
          key: key,
          content: content
        });
      },
      tempDataGetV2: function tempDataGetV2(key) {
        return request('https://common.apifm.com/' + merchantId + '/tempData/get', true, 'get', {
          key: key
        });
      },
      ...
      userAttendantGoods: function userAttendantGoods(id) {
        return request('/user/attendant/goods', true, 'get', {
          id: id
        });
      },
      ...
      userAttendantDaysTimesAttendantSetQuery: function userAttendantDaysTimesAttendantSetQuery(token, day) {
        return request('/user/attendant/daysTimesAttendant/set/query', true, 'get', {
          token: token,
          day: day
        });
      },
      ...
      userAttendantShowPics: function userAttendantShowPics(id) {
        return request('/user/attendant/showPics', true, 'get', {
          id: id
        });
      },
      ...
      shopCategoryDetail: function shopCategoryDetail(id) {
        return request('/shopCategory/info', true, 'get', {
          id: id
        });
      },
      ...
      wxmpOpenid: function wxmpOpenid(code) {
        return request('/user/wxmp/openid', true, 'get', {
          code: code
        });
      },
      ...
      listingDetail: function listingDetail(id) {
        return request('/listingInfo/detail', true, 'get', {
          id: id
        });
      },
      ...
      workingHoursProjectInfo: function workingHoursProjectInfo(code) {
        return request('/workingHours/project', true, 'get', {
          code: code
        });
      },
      ...
      activityVoteInfoDetail: function activityVoteInfoDetail(id) {
        return request('/activityVoteInfo/detail', true, 'get', {
          id: id
        });
      },
      ...
      cpactivityInfoDetail: function cpactivityInfoDetail(id) {
        return request('/cpactivityInfo/detail', true, 'get', {
          id: id
        });
      },
      ...
      memberCardListAll: function memberCardListAll() {
        return request('/member-card/listall', true, 'get', {
          token: wx.getStorageSync('token')
        });
      },
      getMemberCardHxInfo: function getMemberCardHxInfo(id) {
        return request('/member-card/getMemberCardHxInfo?id=' + id, true, 'get', {
          token: wx.getStorageSync('token')
        });
      },
      myMemberCardListAll: function myMemberCardListAll() {
        return request('/member-card/my-member-card', true, 'get', {
          token: wx.getStorageSync('token')
        });
      },
      lingqu: function lingqu(data) {
        return request('/member-card/lingqu', true, 'post', {
          token: wx.getStorageSync('token'),
          ...data
        });
      },
      buyBalancePay: function buyBalancePay(data) {
        return request('/member-card/buy/balance_pay', true, 'post', {
          token: wx.getStorageSync('token'),
          ...data
        });
      },
      buyWxPay: function buyWxPay(data) {
        return request('/member-card/buy/wxpay', true, 'post', {
          token: wx.getStorageSync('token'),
          ...data
        });
      },
      ...
      createPindan: function createPindan(data) {
        return request('/order/createPindan', true, 'post', {
          token: wx.getStorageSync('token'),
          ...data
        }, {
      ...
      // 加入拼单
      joinPindan: function joinPindan(data){
        return request('/order/joinPindan', true, 'post', {
          token: wx.getStorageSync('token'),
          ...data
        }, {
          'Content-Type': 'application/json',
      ...
      getPinDanInfo: function getPinDanInfo(shopId) {
        return request('/order/getPinDanInfo', true, 'get', {
          token: wx.getStorageSync('token'),
          shopId
        }, {
          'Content-Type': 'application/json',
      ...
      getPinDanInfoById: function getPinDanInfoById(id) {
        return request('/order/getPinDanInfoById', true, 'get', {
          token: wx.getStorageSync('token'),
          id
        }, {
          'Content-Type': 'application/json',
      ...
      // 更新拼单配送方式
      updatePindanPeisongTypeById: function updatePindanPeisongTypeById(id) {
        return request('/order/updatePindanPeisongTypeById/' + id, true, 'post', {
          token: wx.getStorageSync('token'),
          id
        }, {
          'Content-Type': 'application/json',
      ...
      // 我发起的拼单
      getMyCreatedPindanRecord: function getMyCreatedPindanRecord(status, page) {
        return request('/order/getMyCreatedPindanRecord?status='+status+"&page="+page, true, 'get', {
          token: wx.getStorageSync('token')
        }, {
          'Content-Type': 'application/json',
          'x-token': wx.getStorageSync('token')
      ...
      // 我参与的拼单
      getMyJoinedPindanRecord: function getMyJoinedPindanRecord(status, page) {
        return request('/order/getMyJoinedPindanRecord?status='+status+"&page="+page, true, 'get', {
          token: wx.getStorageSync('token')
        }, {
          'Content-Type': 'application/json',
          'x-token': wx.getStorageSync('token')
      ...
      // 微信支付 拼单
      wxPayPindan: function wxPayPindan(data) {
